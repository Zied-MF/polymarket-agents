...
export const TRADING_MODES: Record<TradingMode, ModeConfig> = {
  balanced: {
    ...
    minEdge:       0.35,   // 35% edge minimum (vs CLOB bestAsk — win rate 30% exige seuil élevé)
  ...
  aggressive: {
    ...
    minEdge:       0.35,   // 35% edge minimum (vs CLOB bestAsk)
    minConfidence: "LOW",
  },
  high_conviction: {
    ...
    minEdge:       0.40,   // 40% edge minimum (vs CLOB bestAsk)
